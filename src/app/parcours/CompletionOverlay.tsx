...
export default function CompletionOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-6 py-10">
      <div className="animate-pop relative w-full max-w-2xl overflow-hidden rounded-[36px] border border-black/10 bg-white p-10 text-center shadow-[0_30px_90px_rgba(25,20,14,0.2)]">
        ...
        <div className="mt-6 flex items-center justify-center gap-4">
          <button
            ...
            className="rounded-full border border-black/10 bg-white px-6 py-3 text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--ink-700)] transition hover:-translate-y-0.5"
          >
            Fermer
          </button>
        </div>
