  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[image:var(--page-gradient)] px-4 py-6 text-[var(--ink-700)] sm:px-6 sm:py-10">
      ...
      <main className="relative mx-auto flex w-full max-w-6xl flex-col gap-8 sm:gap-12">
        <header className="grid gap-6 rounded-[32px] border border-[color:var(--line)] bg-[color:var(--surface-1)] p-6 shadow-[0_25px_80px_rgba(25,20,14,0.12)] backdrop-blur sm:p-10 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="flex flex-col gap-6">
            <div className="flex flex-wrap items-center gap-3 text-sm uppercase tracking-[0.2em] text-[color:var(--ink-500)]">
              ...
              <span className="rounded-full border border-[color:var(--line)] px-3 py-1">Serious Game</span>
            </div>
          ...
          <div className="rounded-3xl border border-[color:var(--line)] bg-[color:var(--card)] p-6 shadow-[0_20px_60px_rgba(42,32,24,0.16)]">
            <HomeProgressCard />
          </div>
        </header>
      </main>
